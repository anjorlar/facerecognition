        ...
        <main className="pa4 black-80">
          <div className="measure center">
            ...
            <div className="lh-copy mt3">
              <input onClick={() => this.props.onRouteChange('register')} className="b ph3 pv2 input-reset ba b--gray bg-transparent grow pointer f6 dib" type="submit" value="Register" />
            </div>
          </div>
        </main>
      </article>
